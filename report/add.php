...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    $name = $_POST["name"];
    $group_line= $_POST["grouperor"];
    $shirt = $_POST["shirt"];
    $ngay  = $_POST["ngay"];
    $comment  = $_POST["comment"];
    $error = $_POST['data_report_erro'];
    

    $sql = "INSERT INTO data_report (name, group_line,  shirt, erro, ngay , comment) VALUES ('$name', '$group_line', '$shirt','$error', '$ngay', '$comment')";
    $conn->exec($sql);
    echo '<script>alert("Report successful"); window.location.href="./add.php"</script>';
}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <section class="content">
                ...
                <div class="col-md-6">
                    ...
                    <form id="form-add" action="" method="post">
                        ...
                        <input type="date" class="form-control" name="ngay" placeholder="Ngày Lỗi"> <br />
