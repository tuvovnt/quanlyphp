  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
      ...
      <div class="container-fluid">
            ...
            while($row = $query->fetch()){
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?php echo "<a href='view.php?id=$row[id]'>Remove</a>" ?></td>
                     </td>
                    </tr>
                </tbody>
        ...
        <!-- /.row -->
          <button class="btn btn-secondary buttons-csv " tabindex="1" aria-controls="example2" type="button"><span>CSV</span></button>
      </div>
      <!-- /.container-fluid -->
