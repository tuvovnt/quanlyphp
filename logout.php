...
session_start();
session_destroy();
echo "<h3>Đăng Xuất Thành Công</h3>";
...
<i class="fas fa-arrow-right text-muted">Đăng nhập lại để tiếp tục</i>
          </button>
        </div>
      </div>
    </form>
  ...
  <div class="help-block text-center">
    <a href="login.php"> <button type="button" class="btn btn-success btn-lg|btn-sm">Button</button></a>
  </div>
